...
const accessibleActionButtonClass =
  "inline-flex h-10 shrink-0 items-center justify-center gap-1.5 rounded-2xl border border-[#cf0d3d] bg-[#cf0d3d] px-3.5 text-[11px] font-black text-white! shadow-[0_10px_20px_rgba(207,13,61,0.18)] transition visited:text-white! hover:-translate-y-0.5 hover:bg-[#b90b36] hover:text-white! focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-rose-200 active:translate-y-0";
  ...
  return (
    <section>
      <Link
        ...
        prefetch={false}
        className="group block overflow-hidden rounded-lg border border-rose-100 bg-linear-to-r from-rose-50 via-white to-[#fff7fa] p-5 shadow-[0_10px_24px_rgba(102,21,44,0.08)] transition hover:-translate-y-0.5 hover:shadow-[0_16px_36px_rgba(102,21,44,0.12)]"
      >
        <div className="flex items-start justify-between gap-3">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#c93450]">Shortcut Cepat</p>
          ...
          <div className="grid h-11 w-11 place-items-center rounded-lg bg-rose-50 text-[#c93450] transition group-hover:scale-105">
...
export function UserApiCTA() {
  return (
    <section>
      <div className="relative overflow-hidden rounded-[28px] bg-[#c8133f] p-4 text-white shadow-[0_20px_44px_rgba(102,21,44,0.22)] ring-1 ring-white/15">
        <div className="absolute -right-16 -top-16 h-44 w-44 rounded-full bg-white/18 blur-3xl" />
        <div className="absolute -bottom-20 left-8 h-40 w-40 rounded-full bg-[#ff6a8c]/18 blur-3xl" />
        ...
        <div className="relative">
          ...
          <div className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-2">
            <Link
              href="/docs"
              prefetch={false}
              className="inline-flex h-11 items-center justify-center gap-2 rounded-2xl bg-white px-3 text-sm font-black text-[#cf0d3d] shadow-[0_12px_24px_rgba(255,255,255,0.18)] transition hover:bg-rose-50"
            >
...
export function UserWeeklyPromo() {
  return (
    <section>
      <div className="h-44 rounded-lg bg-linear-to-r from-[#c8133f] via-[#f0184f] to-[#a2e2f2] p-5 text-white shadow-sm">
...
export function UserRecentActivity({ href = "/kategori" }: UserRecentActivityProps) {
  return (
    <section className="space-y-3">
      ...
      <div className="rounded-[22px] bg-white p-4 shadow-[0_12px_30px_rgba(102,21,44,0.08)] ring-1 ring-rose-100/80">
        <div className="flex items-center gap-3">
          <div className="relative grid h-12 w-12 shrink-0 place-items-center rounded-[18px] bg-rose-50 text-[#cf0d3d] ring-1 ring-rose-100">
            <span className="absolute -right-1 -top-1 h-4 w-4 rounded-full bg-cyan-300 ring-2 ring-white" />
...
export function UserFavoriteTransactions({ href = "/kategori" }: UserFavoriteTransactionsProps) {
  return (
    <section className="space-y-3">
      ...
      <div className="rounded-[22px] bg-white p-4 shadow-[0_12px_30px_rgba(102,21,44,0.08)] ring-1 ring-rose-100/80">
        <div className="flex items-center gap-3">
          <div className="grid h-12 w-12 shrink-0 grid-cols-2 gap-1 rounded-[18px] bg-rose-50 p-2 ring-1 ring-rose-100">
            <span className="grid place-items-center rounded-lg bg-linear-to-br from-[#cf0d3d] to-[#f0184f] text-white">
              <Smartphone className="h-3.5 w-3.5" strokeWidth={2.5} />
            </span>
            <span className="grid place-items-center rounded-lg bg-linear-to-br from-[#c93450] to-[#a2e2f2] text-white">
              <Wifi className="h-3.5 w-3.5" strokeWidth={2.5} />
            </span>
            <span className="grid place-items-center rounded-lg bg-linear-to-br from-[#f6b100] to-[#ffd76a] text-white">
              <Zap className="h-3.5 w-3.5" strokeWidth={2.5} />
            </span>
            <span className="grid place-items-center rounded-lg bg-linear-to-br from-[#7b44df] to-[#06b6d4] text-white">
  ...
  return (
    <section className="space-y-3">
      ...
      <div className="rounded-[22px] bg-white p-4 shadow-[0_12px_30px_rgba(102,21,44,0.08)] ring-1 ring-rose-100/80">
        <div className="flex items-center gap-3">
          <div className="relative grid h-12 w-12 shrink-0 place-items-center rounded-[18px] bg-rose-50 text-[#cf0d3d] ring-1 ring-rose-100">
            <span className="absolute -right-1 -top-1 grid h-5 w-5 place-items-center rounded-full bg-cyan-300 text-[#08132c] ring-2 ring-white">
...
export function UserAboutSection() {
  return (
    <section>
      <div className="rounded-lg border border-rose-100 bg-white px-4 py-6 shadow-[0_10px_24px_rgba(102,21,44,0.08)]">
        <h3 className="text-lg leading-tight font-bold text-slate-900">Topuna - Solusi Digital untuk Kebutuhan Sehari-hari</h3>
        <p className="mt-3 text-sm leading-relaxed text-slate-600 text-justify">
          Topuna hadir sebagai platform digital untuk memenuhi kebutuhan transaksi online Anda. Tersedia pembayaran praktis dan harga kompetitif. 
          <span><Link href="/tentang" prefetch={false} className="text-[#c93450]! hover:underline!">
            Selengkapnya
          </Link></span>
        </p>
      </div>
