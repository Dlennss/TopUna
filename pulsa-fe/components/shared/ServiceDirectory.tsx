    ...
    <section className="space-y-4 pb-24">
      ...
      <div className="overflow-hidden rounded-[24px] border border-rose-100 bg-linear-to-r from-white via-rose-50 to-white px-4 py-3 shadow-[0_12px_28px_rgba(102,21,44,0.08)]">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-black text-[#651e34]">Transaksi makin praktis</p>
      ...
      {filteredGroups.length > 0 ? (
        filteredGroups.map((group) => (
          ...
          >
            <div className="mb-4 flex items-center gap-2">
              ...
              <span className="rounded-full bg-lime-100 px-2 py-1 text-[10px] font-black text-[#c93450]">
        ...
        <div className="rounded-[26px] border border-dashed border-emerald-200 bg-white p-8 text-center shadow-[0_14px_34px_rgba(6,78,59,0.08)]">
          <BookOpen className="mx-auto h-8 w-8 text-[#c93450]" />
      ...
      <Link
        href={mode === "user" ? "/user" : "/"}
        prefetch={false}
        className="group flex items-center justify-between rounded-[24px] border border-emerald-300/30 bg-[#651e34] px-4 py-4 text-white shadow-[0_16px_34px_rgba(5,46,38,0.22)]"
      >
        <span>
        ...
        <span className="grid h-10 w-10 place-items-center rounded-2xl border border-white/70 bg-lime-300 text-[#651e34] shadow-[0_8px_18px_rgba(163,230,53,0.28)] transition group-hover:translate-x-0.5">
