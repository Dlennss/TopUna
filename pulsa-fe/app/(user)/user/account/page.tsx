...
export default async function UserAccountPage() {
  ...
  const settingItems = [
      ...
      : []),
    {
      ...
      desc: "Ketentuan penggunaan Topuna",
      icon: FileText,
    },
  ];
  ...
  return (
    <main className="min-h-screen bg-[#f3f7f5] pb-24">
      ...
      <div className="mx-auto -mt-4 w-full max-w-md space-y-3.5 px-4">
            ...
            {personalItems.map((item) => {
              ...
              return (
                <div key={item.label} className="flex items-center gap-3 px-4 py-3.5">
                  <Icon className="h-5 w-5 shrink-0 text-[#c93450]" strokeWidth={1.9} />
        ...
        <p className="pt-2 text-center text-[10px] font-semibold text-slate-400">Topuna versi 1.0.0</p>
      </div>
