...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Aktivasi Perdana | Topuna",
      description: "Pilih produk aktivasi perdana operator di Topuna.",
  ...
  return buildPageMetadata({
    title: `Aktivasi Perdana ${brandTitle} | Topuna`,
    description: lowestPrice
      ? `Pilih produk aktivasi perdana ${brandTitle} di Topuna. Produk aktif tersedia mulai Rp ${lowestPrice.toLocaleString("id-ID")}.`
      : `Pilih produk aktivasi perdana ${brandTitle} di Topuna dengan pilihan yang jelas.`,
...
export default async function AktivasiPerdanaBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Aktivasi Perdana ${brandTitle} | Topuna`,
    description: `Pilih produk aktivasi perdana ${brandTitle} di Topuna dengan pilihan yang jelas.`,
    path: `/aktivasi-perdana/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah produk aktivasi perdana ${brandTitle} di Topuna tersedia lengkap?`,
      answer: `Ya. Topuna menampilkan produk aktivasi perdana ${brandTitle} yang aktif agar pembeli bisa memilih sesuai kebutuhan.`,
    },
    {
      question: `Bagaimana cara membeli aktivasi perdana ${brandTitle} di Topuna?`,
    ...
    },
    {
      ...
      answer: `Bisa. Halaman ini dapat dipakai pembeli umum maupun member Topuna untuk transaksi pribadi dan penjualan ulang.`,
    },
  ]);
