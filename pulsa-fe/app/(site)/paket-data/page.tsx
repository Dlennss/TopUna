...
export const metadata: Metadata = buildPageMetadata({
  title: "Paket Data Semua Operator | Topuna",
  description: "Beli paket data harian, mingguan, dan bulanan semua operator di Topuna dengan pilihan grup produk yang lebih jelas.",
  path: "/paket-data",
