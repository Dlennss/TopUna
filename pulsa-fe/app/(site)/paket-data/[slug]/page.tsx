...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!dataCategory) {
    return buildPageMetadata({
      title: "Paket Data Operator | Topuna",
      description: "Beli paket data operator favorit Anda di Topuna.",
      path: "/paket-data",
    });
  }
  ...
  return buildPageMetadata({
    title: `Paket Data ${brandTitle} Murah | Topuna`,
    description: lowestPrice
      ? `Beli paket data ${brandTitle} di Topuna dengan pilihan kuota aktif. Harga mulai Rp ${lowestPrice.toLocaleString("id-ID")} dan transaksi cepat.`
      : `Beli paket data ${brandTitle} di Topuna dengan pilihan kuota dan masa aktif yang jelas.`,
...
export default async function GuestPaketDataBrandPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `Paket Data ${brandTitle} Murah | Topuna`,
    description: `Beli paket data ${brandTitle} di Topuna dengan pilihan kuota dan masa aktif yang jelas.`,
    path: `/paket-data/${slug}`,
  ...
  const faqJsonLd = buildFaqJsonLd([
    {
      question: `Apakah paket data ${brandTitle} di Topuna tersedia dalam banyak pilihan kuota?`,
      answer: `Ya. Topuna menampilkan paket data ${brandTitle} yang aktif dengan pilihan kuota, masa aktif, dan grup produk yang lebih jelas.`,
    },
    {
      question: `Bagaimana cara beli paket data ${brandTitle} di Topuna?`,
    ...
    },
    {
      ...
      answer: `Halaman ini bisa dipakai pembeli umum maupun member Topuna untuk kebutuhan transaksi harian dan penjualan ulang.`,
    },
  ]);
