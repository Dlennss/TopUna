...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Internet Pascabayar | Topuna",
      description: "Cek dan bayar tagihan internet pascabayar di Topuna.",
      path: "/internet-pascabayar",
    });
  }

  return buildPageMetadata({
    title: `${toTitleCase(brand.nama)} | Internet Pascabayar Topuna`,
    description: `Cek dan bayar tagihan ${toTitleCase(brand.nama)} di Topuna dengan proses yang ringkas.`,
...
export default async function InternetPascabayarSlugPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${brandTitle} | Internet Pascabayar Topuna`,
    description: `Cek dan bayar tagihan ${brandTitle} di Topuna dengan proses yang ringkas.`,
    path: `/internet-pascabayar/${slug}`,
