...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!article) {
    return {
      title: "Artikel Tidak Ditemukan | Topuna",
    };
  }

  return {
    metadataBase: new URL(CANONICAL_SITE_URL),
    title: `${article.title} | Topuna`,
...
export default async function ArtikelDetailPage({ params }: Props) {
  ...
  const ctaDescription =
    article.category === "Bisnis Agen"
      ? "Setelah memahami arahnya, lanjutkan ke halaman Topuna yang paling membantu pertumbuhan usaha dan layanan member Anda."
      : article.category === "Panduan Member"
        ...
        : article.category === "H2H"
          ...
          : article.category === "Deposit"
            ...
            : "Jika Anda sudah memahami produknya, lanjutkan ke halaman layanan Topuna yang paling relevan untuk kebutuhan Anda.";
  ...
  return (
    <main className="relative overflow-hidden bg-slate-50 text-slate-900">
      ...
      <article className="relative space-y-4 px-4 pb-6 pt-4">
        ...
        <section className="rounded-md border border-sky-200 bg-linear-to-r from-[#c93450] via-[#c93450] to-[#c93450] p-4 text-white shadow-[0_24px_60px_rgba(15,111,203,0.22)]">
          ...
          <Link
            ...
            className="mt-4 inline-flex h-11 items-center justify-center rounded-full bg-white px-5 text-sm font-semibold text-[#c93450]! visited:text-[#c93450]! hover:bg-sky-50 hover:text-[#c93450]!"
          >
            {article.ctaLabel}
          </Link>
        </section>
