...
const pageTitle = "Privacy Policy Topuna | Website and Android App";
const pageDescription =
  "Privacy policy for Topuna website and Android application, including account data, transactions, security, and Google sign-in usage.";
