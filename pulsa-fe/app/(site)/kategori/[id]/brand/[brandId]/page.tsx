...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return buildPageMetadata({
    title: `${brand} | ${categoryName} Topuna`,
    description: `Lihat produk ${brand} pada kategori ${categoryName} di Topuna.`,
...
export default async function GuestBrandProductsPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${brand} | ${categoryName || "Produk"} Topuna`,
    description: `Lihat produk ${brand} pada kategori ${categoryName || "produk"} di Topuna.`,
    path: `/kategori/${id}/brand/${brandId}`,
