...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (universalService) {
    return buildPageMetadata({
      title: `${universalService === "esim-roaming" ? "eSIM & Roaming" : "HP Pascabayar"} | Topuna`,
      description: "Layanan digital Topuna.",
      path: `/kategori/${id}`,
    });
  }
  ...
  if (!category) {
    return buildPageMetadata({
      title: "Kategori Produk | Topuna",
      description: "Lihat kategori produk Topuna.",
      path: "/kategori",
    });
  }

  return buildPageMetadata({
    title: `${category.nama} | Topuna`,
    description: `Lihat pilihan brand dan produk ${category.nama} di Topuna.`,
    path: `/kategori/${id}`,
...
export default async function GuestKategoriPage({ params }: PageProps) {
  ...
  const collectionJsonLd = buildCollectionJsonLd({
    title: `${categoryName} | Topuna`,
    description: `Lihat pilihan brand dan produk ${categoryName} di Topuna.`,
    path: `/kategori/${id}`,
