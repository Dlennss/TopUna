...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Tagihan PGN | Topuna",
      description: "Cek dan bayar tagihan gas PGN di Topuna.",
      path: "/pgn",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | Tagihan PGN Topuna`,
    description: `Cek dan bayar tagihan ${brand.nama} di Topuna dengan proses yang ringkas.`,
    path: `/pgn/${slug}`,
