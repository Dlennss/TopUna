...
export const metadata: Metadata = buildPageMetadata({
  title: "Pulsa Semua Operator | Topuna",
  description: "Isi pulsa Telkomsel, Indosat, XL, Axis, Smartfren, dan operator lain di Topuna dengan pilihan nominal yang jelas dan transaksi cepat.",
  path: "/pulsa",
