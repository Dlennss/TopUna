...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "Tagihan PDAM | Topuna",
      description: "Cek dan bayar tagihan PDAM di Topuna.",
      path: "/pdam",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | Tagihan PDAM Topuna`,
    description: `Cek dan bayar tagihan ${brand.nama} di Topuna dengan proses cepat dan ringkas.`,
    path: `/pdam/${slug}`,
