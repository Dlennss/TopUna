...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!brand) {
    return buildPageMetadata({
      title: "TV Berlangganan | Topuna",
      description: "Beli paket atau bayar layanan TV berlangganan di Topuna.",
      path: "/tv",
    });
  }

  return buildPageMetadata({
    title: `${brand.nama} | TV Berlangganan Topuna`,
    description: `Beli paket atau bayar layanan ${brand.nama} di Topuna dengan proses yang ringkas.`,
    path: `/tv/${slug}`,
