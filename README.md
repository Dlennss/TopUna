...
Optimistis, ekspresif dan ringkas. Top up, lanjut lagi.
...
Logo, banner, nama tampilan, metadata, font dan warna memakai identitas Topuna.
...
Alamat lokal: http://localhost:3103
...
Konfigurasikan pulsa-be/.env berdasarkan .env.example. Gunakan database topuna
dan akun H2HR yang ditetapkan untuk aplikasi ini. Jalankan migrasi sesuai dokumentasi
proyek asal, lalu jalankan go run . dari pulsa-be. Port backend: 8103.
...
lalu arahkan service khusus topuna ke release tersebut.
